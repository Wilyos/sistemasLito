...
const Soluciones = () => {
    ...
    const products = [
        { id: 1, name: 'Editorial', image: require('../../assets/catalogo/revista.png'), categoria: ['Editorial'], descripcion: 'Transformamos ideas en publicaciones memorables. Ideal para libros, revistas y más.' },
        ...
        { id: 11, name: 'Periódico', image: require('../../assets/catalogo/periodicos.webp'), categoria: ['Editorial','Publicidad'], descripcion: 'Ideal para medios internos, publicaciones comunitarias o promocionales. Efectivo y económico.' },
        ...
        { id: 35, name: 'Pendón', image: require('../../assets/catalogo/pendon.webp'), categoria: ['Publicidad Exterior', 'MaterialPop'], descripcion: 'Impacto visual en eventos o puntos de venta. Pendones resistentes y personalizados.' },
        { id: 36, name: 'Rompe Tráfico', image: require('../../assets/catalogo/rompetrafico.webp'), categoria: ['Publicidad Exterior', 'MaterialPop'], descripcion: 'Diseños resistentes para captar atención en zonas de alto tránsito. Publicidad directa y efectiva.' },
        ...
        { id: 42, name: 'Exhibidor', image: require('../../assets/catalogo/gondola.webp'), categoria: ['MaterialPop'], descripcion: 'Resalta tus productos con exhibidores personalizados. Funcionalidad y marca en un solo elemento.' },
